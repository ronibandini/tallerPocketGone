...
3. Descargar [getMacOTA.ino](https://github.com/ronibandini/tallerPocketGone/blob/main/getMacOta.ino), abrirlo con el Arduino IDE, conectar la placa NodeMCU ESP-32S con un cable USB y subirle a la placa el sketch
